...
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
var initMenu = function initMenu(preventScrollLock) {
  var menuOpenBtn = document.querySelector(".hamburger");
  ...
  navLinks.forEach(function (el) {
    return el.addEventListener("click", closeMenu);
  });
};
...
var modalLoginBtns = document.querySelectorAll('[data-modal="login"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
